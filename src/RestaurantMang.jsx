      ...
      {deleteId && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
          <div className="bg-[#1B2D47] rounded-lg shadow-lg p-8 w-[440px] h-[285px] gap-[15px] flex flex-col items-center justify-center">
            <img src="deleteicon.png" alt=""  />
            <div className="text-white text-lg mb-4 font-semibold font-onset text-center ">Are you sure you want to delete this 
              <div className="text-gray-300 font-normal mt-2 "> 
                This action cannot be undone. This will be permanently removed from the database.
              </div>
            </div>
